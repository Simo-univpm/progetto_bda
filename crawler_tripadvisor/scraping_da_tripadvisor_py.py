# -*- coding: utf-8 -*-
"""Scraping da Tripadvisor.py

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1BZB2tyi6GklcJ7DC6EPjP907-0RwwGrs
...
for i in url:
  ...
  print("> NOME: " +  camping_name)
  print("> INDIRIZZO: " + camping_address)
  print("> DESCRIZIONE: " + camping_about)
  print("> SERVIZI: ")
  print(servizi_appoggio)
...
def editLinksReviews(url):
  ...
  num_pag = int(math.ceil(int(num_reviews.text)/5))
  pag_review = 0
  ...
  for pippo in edited_links_reviews:
    print(pippo)

editLinksReviews(url)